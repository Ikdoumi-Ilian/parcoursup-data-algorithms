...
lis_orientation_test1=[orientation(effectif_EG=1.0, region='Bordeaux', filiere='Philosophie'),
                       ...
                       orientation(effectif_EG=77.0, region='Nantes', filiere='Sciences et Techniques des Activités Physiques et Sportives')]

lis_orientation_test1_triee=triee_par_indice_min_orientation(lis_orientation_test1)


print(nombres_occurrences(lis_orientation_test1_triee , effectif_EG=77.0))  # Résultat attendu 3
print(nombres_occurrences(lis_orientation_test1_triee , effectif_EG=1.0))  # Résultat attendu 2
print(nombres_occurrences(lis_orientation_test1_triee , effectif_EG=97.0))  # Résultat attendu 0
