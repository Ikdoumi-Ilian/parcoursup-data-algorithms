...
print(recherche_dicho_plus_grand_indice(lis_orientation_test1_triee , effectif_EG=77.0))  # Résultat attendu 3
print(recherche_dicho_plus_grand_indice(lis_orientation_test1_triee , effectif_EG=1.0))  # Résultat attendu 1
print(recherche_dicho_plus_grand_indice(lis_orientation_test1_triee , effectif_EG=97.0))  # Résultat attendu 4
print(recherche_dicho_plus_grand_indice(lis_orientation_test1_triee , effectif_EG=7.0))  # Résultat attendu -1
